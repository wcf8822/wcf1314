...
#define SETTING_FIRSTRUN_JUDGE 0x58     //判断是否第一次上电的数值
#define SETTING_FIRSTRUN_ADDR  0x000000 //第一次上电地址
#define SETTING_CNORENG_ADDR   0x000100 //默认设置是中英文
#define LOG_COUNT_ADDR         0x000200 //记录条数初始地址
#define SETTING_START_ADDR     0x000300 //设置保存的地址
#define LOG_FIRST_ADDR         0x3CB000 //第一条数据记录地址
