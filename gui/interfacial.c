...
const uint8_t software_version[] = "v0.95";  //软件版本
				...
				{//校准模式逻辑
					switch(temp_SensorType)
					{
						case TYPE_DO:
							...
							STD_value = NanoOptionList_GetValue(cur_interfacial.option_head->son_option, 10)/10.0;//计算校准的值
						
							snprintf(cal_arr, 8, "%05.01f %%", STD_value);//将校准值写入校准文字buff
